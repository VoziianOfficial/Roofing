(function(){
  ...
  if(window.Swiper) document.querySelectorAll('.facts-swiper').forEach(swiper=>{const shell=swiper.closest('.facts-shell');new Swiper(swiper,{direction:'vertical',loop:true,speed:650,slidesPerView:1,spaceBetween:20,grabCursor:true,keyboard:{enabled:true},autoplay:{delay:4800,disableOnInteraction:false},navigation:{prevEl:shell&&shell.querySelector('[data-facts-prev]'),nextEl:shell&&shell.querySelector('[data-facts-next]')}})});
